...
if (isset($CURUSER)){
    ...
    $HTMLOUT .= "<p>".sprintf($lang['ok_account_active_login'], "<a href='{$FMED['baseurl']}/index.php'><b>{$lang['ok_account_active_login_link']}</b></a>")."</p>\n";
    $HTMLOUT .= sprintf($lang['ok_read_rules'], $FMED['site_name']);
    $HTMLOUT .= stdfoot();
    print $HTMLOUT;
    }else{
    $HTMLOUT .= stdhead("{$lang['ok_signup_confirm']}");
