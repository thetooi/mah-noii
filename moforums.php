...
$desc =  mysql_escape_string( htmlspecialchars($_POST['desc']));
...
echo "<tr><td><a href=newforums.php?action=forumview&forid=".$row["id"]."><b>".$row["name"]."</b></a><br>".$row["description"]."</td>";
...
<table width="100%"  border="0" cellspacing="0" cellpadding="3" align="center">
<tr align="center">
    <td colspan="2" class=colhead>edit overforum: <?=$row["name"];?></td>
  </tr>
...
?>
  ...
  <tr align="center">
    <td colspan="2"><input type="hidden" name="action" value="editforum"><input type="hidden" name="id" value="<?=$id;?>"><input type="submit" name="Submit" value="Edit overforum"></td>
  </tr>
</table>
