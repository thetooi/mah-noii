...
echo($pagertop);
echo"<table width=650><tr><td class=colhead2 align=left valign=top>Added</td><td class=colhead2 align=left valign=top>Reported by</td>".
"<td class=colhead2 align=left valign=top>Reporting What</td><td class=colhead2 align=left valign=top>Type</td><td class=colhead2 align=left valign=top>Reason</td>".
"<td class=colhead2 align=center valign=top>Dealt With</td><td class=colhead2 align=center valign=top>Deal With It</td>".
"".(get_user_class() == UC_SYSOP ? "<td class=colhead2 align=center valign=top>Delete</td>" : "")."</tr><form method=post action=reports.php?deal_with_report=1>";
...
echo"<tr><td align=left valign=top class=$class>".$arr_info['added']."</td><td align=left valign=top class=$class><a class=altlink href=userdetails.php?id=".$arr_info['reported_by'].">".
"<b>".$arr_info['username']."</b></a></td><td align=left valign=top class=$class>$link_to_thing</td><td align=left valign=top class=$class><b>".str_replace("_" , " ",$arr_info["reporting_type"])."</b>".
"</td><td align=left valign=top class=$class>".safechar($arr_info['reason'])."</td><td align=center valign=top class=$class>$dealtwith $delt_link</td><td align=center valign=middle class=$class>$checkbox</td>".(get_user_class() == UC_SYSOP ? "<td align=center valign=middle class=$class><a class=altlink href=reports.php?id=".$arr_info['id']."&delete=1><font color=red>Delete</font></a></td>" : "")."</tr>\n";
...
if ($count > '0'){
//=== deal with it
echo"<br><br><p align=center><b>How $CURUSER[username] Delt with this report:</b> [ required ] </p><textarea name=how_delt_with cols=70 rows=5 ></textarea><br><br>".
"<input type=submit class=groovybutton value=Confirm><br><br></form></td></tr></table>";
