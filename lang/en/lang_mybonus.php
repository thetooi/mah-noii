<?php
    ...
    'bonus_notthere_msg' => "How can we remove a warning that isn't there?<br />go back to your <a class='altlink' href='{$FMED['baseurl']}/mybonus.php'>Karma Bonus Point</a> page and think that one over.",
    'bonus_lower_msg' => "Now why would you want to lower yourself to VIP?<br />go back to your <a class='altlink' href='{$FMED['baseurl']}/mybonus.php'>Karma Bonus Point</a> page and think that one over.",
    'bonus_notorrent_msg' => "No torrent with that ID!<br />Back to your <a class='altlink' href='{$FMED['baseurl']}/mybonus.php'>Karma Bonus Point</a> page.",
    'bonus_notenough_msg' => " you don\'t have enough Karma points.",
    'bonus_fineratio_msg' => "Your ratio on that torrent is fine, you must have selected the wrong torrent ID.<br />Back to your <a class='altlink' href='{$FMED['baseurl']}/mybonus.php'>Karma Bonus Point</a> page.",
    ...
    'bonus_exchangepoints' => "Exchange your <a class='altlink' href='{$FMED['baseurl']}/mybonus.php'>Karma Bonus Points</a> [ current ",
    ...
    'bonus_goback' => " Click to go back to your <a class='altlink' href='{$FMED['baseurl']}/mybonus.php'>Karma Bonus Point</a> page.",
