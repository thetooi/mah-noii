...
'tags_tags' => "Tags",
'tags_title' => "<p>The {$FMED['site_name']} forums supports a number of <i>BB tags</i> which you can embed to modify how your posts are displayed.</p>",
...
'tags_hyper4' => "[url]".$FMED['baseurl']."/[/url]",
...
'tags_hyper9' => "[url=".$FMED['baseurl']."/]".$FMED['site_name']."[/url]",
...
'tags_image4' => "[img=".$FMED['baseurl']."/pic/logo.gif]",
...
'tags_image9' => "[img]".$FMED['baseurl']."/pic/logo.gif[/img]",
