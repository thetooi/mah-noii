...
#FAQ
'faq_welcome' => "<b>Welcome to {$FMED['site_name']}!</b><br />
    <br />
    ...
    Before you do anything here at {$FMED['site_name']} we suggest you read the <a class='altlink' href='rules.php'>rules</a>!
    There are only a few rules to abide by, but we do enforce them!<br />
    <br />
    Before you go any further you should read the {$FMED['site_name']} <a class='altlink' href='useragreement.php'>user agreement</a>.
    <br />",
...
'faq_userinfo' => "<ul>
        ...
        <img src='{$FMED['pic_base_url']}updated.png' alt='Updated' width='46' height='11' /></li>
...
'faq_uploading' => "<ul>
      ...
      <img src='{$FMED['pic_base_url']}new.png' alt='New' width='27' height='11' /></li>
      </ul>
    <br />",
...
'faq_siteinfo_body' => "<br />
    ...
    <br />
    {$FMED['site_name']} is situated on a dedicated server in the Netherlands.
    ...
    <br />
    Snapshots are available on the <a href='www.FMED.net/index.php?app=downloads' class='altlink'>FTP</a>. Please note: We do not give any kind of support on the source code so please don't bug us about it. If it works, great, if not too bad. Use this software at your own risk!
    <p>
    Here is a nice tutorial on getting it all to work, written by one of our users: <a href='http://www.FMED.net'>FMED.NET</a>. Note: This tutorial is not supported by FMED. Please direct all comments on the tutorial to the author, <b>MrMister</b>.</p>",
'faq_userinfo_body' => "<b>I registered an account but did not receive the confirmation e-mail!</b><a name='user1' id='user1'></a><br />
    ...
    <tr>
      <td class='embedded' bgcolor='#F5F4EA'>&nbsp;  <img src='{$FMED['pic_base_url']}star.gif' alt='Star' /></td>
      <td class='embedded' width='5'>&nbsp;</td>
      <td class='embedded'>Has donated money to {$FMED['site_name']} . </td>
    </tr>
    <tr>
      <td class='embedded' valign='top' bgcolor='#F5F4EA'>&nbsp; <b>VIP</b></td>
      <td class='embedded' width='5'>&nbsp;</td>
      <td class='embedded' valign='top'>Same privileges as Power User and is considered an Elite Member of {$FMED['site_name']}. Immune to automatic demotion.</td>
    </tr>
    <tr>
...
'faq_stats_body' => "<br />
    ...
    * TorrentStorm.<br />
    ...
    <br />
    <b>1.</b> <i>You are the single {$FMED['site_name']} users in the LAN</i><br />
    <br />
    You should use the same {$FMED['site_name']} account in all the computers.<br />
    <br />
    ...
    <br />
    <br />
    <b>2.</b> <i>There are multiple {$FMED['site_name']} users in the LAN</i><br />
    <br />
    At present there is no way of making this setup always work properly with {$FMED['site_name']}.
...
'faq_uploading_body' => "<br />
    ...
    * you'll be able to seed, or make sure are well-seeded, for at least 24 hours.<br />
    ...
    be unable to connect with us. This generates a lot of frustration and bad-will against us at {$FMED['site_name']},
...
'faq_downloading_body1' => "This applies to new users as well, so opening a new account will not help. Note also that this
    ...
    <br />
    {$FMED['site_name']} does not allow clients to use ports commonly associated with p2p protocols.
...
'faq_proxy_body2' => "<tr>
    ...
    <br />
    The {$FMED['site_name']} tracker is quite smart at finding your real IP, but it does need the proxy to send the HTTP header
    ...
    thing to try should be connecting to {$FMED['baseurl']}:81. Note that even if this works your bt client will still try
    ...
    <ul>
      ...
      the list followed by your IP then everything should be ok, otherwise choose another proxy and try again.<br /></li>
        ...
        <li>Visit {$FMED['site_name']}. Hopefully the tracker will now pickup your real IP (check your profile to make sure).</li>
    </ul>
    <br />
    ...
    <br />
    This section was written for {$FMED['site_name']}, a closed, port 80-81 tracker. Other trackers may be open or closed, and many listen
...
'faq_alt_port_body' => "<br />
    ...
    and replacing the announce url {$FMED['baseurl']}:81 with {$FMED['site_name']}:80 or just {$FMED['site_name']}.<br />
    <br />
    ...
    {$FMED['site_name']}:80, not {$FMED['site_name']}. (If you're thinking about changing the number before the
