...
'upload_html_bbcode' => "HTML/BB code is <b>not</b> allowed.",
'upload_choose_one' => "choose one",
'upload_type' => "Type",
'upload_submit' => "Do it!",
'upload_free' => "Freeleach",
'upload_free_download' => "Check thos box for Freeleach Download",
'upload_box' => "Seedbox",
'upload_box_only' => "Seedbox Torrant Only",
'upload_vip' => "Upload v.i.p",
'upload_vip_only' => "Upload V-I-P Torrant Only",
