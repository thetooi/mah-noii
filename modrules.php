...
echo("<form method=\"post\" action=\"modrules.php?act=addsect\">");
...
echo("<tr><td align=center><a href=modrules.php?act=newsect>Add Section</a></td></tr></table>\n");
while ($arr=mysql_fetch_assoc($res)){
echo("<br><table width=95% border=1 cellspacing=0 cellpadding=10>");
echo("<form method=post action=modrules.php?act=edit&id=><tr><td class=colhead>:: $arr[title]</td></tr><tr><td><ul>\n");
