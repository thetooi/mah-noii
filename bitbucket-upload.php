...
if (($it == IMAGETYPE_GIF && $ext != ".gif") || ($it == IMAGETYPE_JPEG && $ext != ".jpg") || ($it == IMAGETYPE_PNG && $ext != ".png"))
    ...
    $url = str_replace(" ", "%20", htmlspecialchars("{$FMED['baseurl']}/bitbucket/$filename"));
    ...
    <form method='post' action='{$FMED['baseurl']}/bitbucket-upload.php' enctype='multipart/form-data'>
    <p><b>{$lang['bitbucket_maximum']}".number_format($FMED['bb_upload_size'])."{$lang['bitbucket_bytes']}</b></p>
