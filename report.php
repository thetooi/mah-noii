...
stdhead("Confirm");
echo("<table width=650><tr><td class=colhead><h1>Success!</h1></td></tr>".
"<tr><td class=clearalt6 align=center>Successfully Reported <b>".str_replace("_" , " ",$type)."</b> with id: <b>$id</b>!<br><b>Reason:</b> $reason</td></tr></table>");
...
stdhead("Report");
echo("<form method=post action=report.php?type=$type$id_2b&id=$id&do_it=1><table width=650><tr><td class=colhead colspan=2><h1>Report: ".str_replace("_" , " ",$type)."</h1></td></tr>".
"<tr><td class=clearalt6 colspan=2 align=center><img src=pic/warned.gif alt=warned> Are you sure you would like to report <b>".str_replace("_" , " ",$type)."</b> with id: <b>$id</b>".
"<img src=pic/warned.gif alt=warned><br>to the Staff for violation of the <a class=altlink href=rules.php target=_blank>rules</a>?</td></tr>".
...
"<tr><td class=clearalt6 colspan=2 align=center><input type=submit class=groovybutton value=\"Confirm Report\"></form></td></tr>");
end_table();
stdfoot();
die;
?>