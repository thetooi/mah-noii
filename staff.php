...
$arr['username']."</a></td><td class=staffembedded> ".("'".$arr['last_access']."'">$dt?"<img src=".$pic_base_url."button_online.gif border=0 alt=\"online\">":"<img src=".$pic_base_url."button_offline.gif border=0 alt=\"offline\">" )."</td>".
"<td class=staffembedded><a href=messages.php?action=send&receiver=".$arr['id'].">".
...
"<td class=embedded><a href=messages.php?action=send&receiver=".$arr['id'].">"."<img src=".$pic_base_url."button_pm.gif border=0></a></td>".
