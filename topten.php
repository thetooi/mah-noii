...
<td class=colhead align=right><?=$what?></td></tr><?
  	$num = 0;
		while ($a = mysql_fetch_assoc($res))
		{
	    ++$num;
...
// BEGIN CACHE ///////////////////////////////////////////////////////////
     ...
     {
        include($cachefile);
        print("<p align=center><font class=small>This page last updated ".date('Y-m-d H:i:s', filemtime($cachefile)).". Started recording account xfer stats on 2003-08-31</font></p>");
        end_main_frame();
        stdfoot();
...
/////////////////////////////////////////////////////////
  ...
  end_main_frame();
  print("<p><font class=small>Started recording account xfer stats on 2008-08-31</font></p>");
stdfoot();
?>