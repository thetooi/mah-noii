...
define('TIME_NOW', time());
    ...
    $FMED['cookie_prefix']  = 'toui_'; // This allows you to have multiple trackers, eg for demos, testing etc.
    ...
    $FMED['site_online'] = 1;
    $FMED['tracker_post_key'] = 'ls@dflksfda4545frwe35@kk';
...
define('ROOT_PATH', $file_path);
    ...
    $FMED['announce_urls'][] = "https://i.toui.cc/announce.php";
if ($_SERVER["HTTP_HOST"] == "")
    $_SERVER["HTTP_HOST"] = $_SERVER["SERVER_NAME"];
    $FMED['baseurl'] = "https://" . $_SERVER["HTTP_HOST"]."";
    $FMED['site_email'] = "noreply@toui";
    $FMED['site_name'] = "toui";
    $FMED['language'] = 'en';
