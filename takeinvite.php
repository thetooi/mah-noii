...
echo("<table width='100%' height='100%' style='border: 8px ridge #000000'><tr><td align='center'>");
echo("<center><h1 style='color: #CC3300;'>Error:</h1><h2>" . htmlspecialchars($text) . "</h2></center>");
...
$ret2 = mysql_query("UPDATE users SET invites='$invites' WHERE id = $id2");
...
header("Refresh: 0; url=invite.php");
?>